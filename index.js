...
function DisplayRecords() {
    ...
    for (var i = 0; i < allRecord.length; i++) {
        var row;
        if (i % 2 === 0) {
            row = '<tbody class="delete"><tr class="stripe"><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].registration + '</td><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].date + '</td><td style="vertical-align: middle; width: 160px; max-width: 160px;" rowspan="3">' + allRecord[i].tlprange + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].msn + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].e1esn + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].e2esn + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].apusn + '</td><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].chka + '</td><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].chkc + '</td><td style="vertical-align: middle; width: 200px; max-width: 200px;" rowspan="3">' + allRecord[i].remarks + '</td></tr><tr class="stripe"><td style="vertical-align: middle;">' + allRecord[i].afhrs + '</td><th style="vertical-align: middle; width: 10px;">FH</th><td style="vertical-align: middle;">' + allRecord[i].e1hrs + '</td><th style="vertical-align: middle; width: 10px;">FH</th><td style="vertical-align: middle;">' + allRecord[i].e2hrs + '</td><th style="vertical-align: middle; width: 10px;">FH</th><td style="vertical-align: middle;">' + allRecord[i].apuhrs + '</td><th style="vertical-align: middle; width: 10px;">Hrs</th></tr><tr class="stripe"><td>' + allRecord[i].afcyc + '</td><th>FC</th><td>' + allRecord[i].e1cyc + '</td><th>FC</th><td>' + allRecord[i].e2cyc + '</td><th>FC</th><td>' + allRecord[i].apucyc + '</td><th>Cyc</th></tr></tbody>';
        } else {
            row = '<tbody class="delete"><tr class=""><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].registration + '</td><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].date + '</td><td style="vertical-align: middle; width: 160px; max-width: 160px;" rowspan="3">' + allRecord[i].tlprange + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].msn + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].e1esn + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].e2esn + '</td><td colspan="2" style="font-weight: 400; color: DarkCyan;">' + allRecord[i].apusn + '</td><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].chka + '</td><td style="vertical-align: middle;" rowspan="3">' + allRecord[i].chkc + '</td><td style="vertical-align: middle; width: 200px; max-width: 200px;" rowspan="3">' + allRecord[i].remarks + '</td></tr><tr class=""><td style="vertical-align: middle;">' + allRecord[i].afhrs + '</td><th style="vertical-align: middle; width: 10px;">FH</th><td style="vertical-align: middle;">' + allRecord[i].e1hrs + '</td><th style="vertical-align: middle; width: 10px;">FH</th><td style="vertical-align: middle;">' + allRecord[i].e2hrs + '</td><th style="vertical-align: middle; width: 10px;">FH</th><td style="vertical-align: middle;">' + allRecord[i].apuhrs + '</td><th style="vertical-align: middle; width: 10px;">Hrs</th></tr><tr class=""><td>' + allRecord[i].afcyc + '</td><th>FC</th><td>' + allRecord[i].e1cyc + '</td><th>FC</th><td>' + allRecord[i].e2cyc + '</td><th>FC</th><td>' + allRecord[i].apucyc + '</td><th>Cyc</th></tr></tbody>';
        }
        table += row;
    }
